...
// Seiteneffekte. Wird von lib/autobacktest.mjs mit den dort ohnehin schon
// wöchentlich geladenen historischen Kerzen aufgerufen (bewusst KEIN
// eigener Klines-Abruf hier, um die externen Anfragen pro Lauf nicht zu
...
// null bei zu wenig gemeinsamen Datenpunkten oder wenn eine Serie konstant
// ist (Standardabweichung 0 - Division durch 0 wäre irreführend).
...
// closesProSymbol: { SYMBOL: [close, close, ...], ... }. Gibt { SYMBOL: { ANDERES_SYMBOL: -1..1 oder null } } zurück.
