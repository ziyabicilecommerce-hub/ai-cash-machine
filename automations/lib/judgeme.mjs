...
export async function getReviews({ perPage = 30, page = 1 } = {}) {
  if (!config.JUDGEME_API_TOKEN || !config.JUDGEME_SHOP_DOMAIN) {
    ueberspringenWerfen('JUDGEME_API_TOKEN/JUDGEME_SHOP_DOMAIN-Secret ist nicht gesetzt - bitte in GitHub → Settings → Secrets and variables → Actions eintragen (siehe automations/README.md).');
  }
