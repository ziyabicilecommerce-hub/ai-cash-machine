...
// Erweiterte Risiko-/Performance-Kennzahlen über die Trade-Historie (Pendant
// zum Krypto-Bot) - reine Statistik, keine Prognose. Sharpe/Sortino sind
// BEWUSST NICHT die klassischen annualisierten Lehrbuch-Kennzahlen (dafür
